...
[assembly: MelonInfo(typeof(ChallengeRarity.Main), "ChallengeOnlyLegendary", "1.0.0", "Fur")]
...
public class ChallengeOnlyLegendary : MelonMod
{
    ...
    class LuckPatch
    {
        ...
        {
            itemRarities = new List<Item2.Rarity> { Item2.Rarity.Legendary };
